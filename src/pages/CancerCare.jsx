  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="p-4 sm:p-5 bg-amber-500/10 border-l-4 border-amber-600 rounded-r-2xl mb-8 flex items-start gap-3.5 text-xs text-earth-900">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-10">
          <div className="lg:col-span-7 space-y-4">
            ...
            <div className="space-y-2.5 pt-1">
              <h3 className="font-serif text-base sm:text-lg text-forest-950">Core Goals of Supportive Consultation:</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs text-earth-800">
                <div className="flex items-center gap-2 p-3 bg-white rounded-xl border border-earth-200 shadow-sm">
        ...
        <div className="p-6 sm:p-8 bg-white rounded-3xl border border-earth-200 shadow-elevated mb-10 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5 text-xs text-earth-800 font-light">
            <div className="p-4 sm:p-5 bg-cream-50 rounded-2xl border border-earth-200 space-y-1.5">
        ...
        <div className="space-y-4 mb-10">
          <h2 className="text-2xl sm:text-3xl font-serif font-light text-forest-950 flex items-center gap-2.5">
            <HelpCircle className="w-5 h-5 text-brass-600" />
            <span>Frequently Asked Questions</span>
          </h2>

          <div className="space-y-3 text-xs text-earth-800">
            <div className="p-5 bg-white rounded-2xl border border-earth-200 space-y-1.5">
              <h3 className="font-semibold text-sm text-forest-950">Does Ayurveda cure cancer?</h3>
              <p className="leading-relaxed font-light">No. We do not claim that Ayurveda cures cancer or replaces oncology treatments. Our consultations focus on supportive care, digestive strength, and quality of life.</p>
            </div>

            <div className="p-5 bg-white rounded-2xl border border-earth-200 space-y-1.5">
              <h3 className="font-semibold text-sm text-forest-950">Should I inform my oncologist before starting Ayurvedic herbs?</h3>
              <p className="leading-relaxed font-light">Yes, absolutely. We encourage open communication with your primary oncology team so all ongoing treatments and herbs are safely coordinated.</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 sm:p-8 bg-forest-950 text-cream-50 rounded-3xl flex flex-col sm:flex-row sm:items-center justify-between gap-5">
          <div className="space-y-1.5">
            <h3 className="font-serif text-xl sm:text-2xl font-light">Enquire About a Supportive Consultation</h3>
