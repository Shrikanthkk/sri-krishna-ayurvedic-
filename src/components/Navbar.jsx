...
export default function Navbar({ onOpenBooking }) {
  ...
  return (
    <>
      ...
      >
        <div className="w-full max-w-[1600px] mx-auto pl-0 sm:pl-2 pr-3 sm:pr-5 lg:px-6 flex items-center justify-between overflow-visible relative">
          
          {/* Left Group: Logo, Brand Info, Divider, and Nav Links */}
          <div className="flex items-center gap-2 sm:gap-3 lg:gap-4 xl:gap-5 overflow-visible">
            ...
            >
              ...
              <div className="relative w-[70px] h-[70px] sm:w-[82px] sm:h-[82px] md:w-[88px] md:h-[88px] translate-y-1.5 sm:translate-y-2 rounded-full p-1 sm:p-1.5 bg-gradient-to-b from-white via-cream-50 to-cream-100 border border-brass-400/60 shadow-[0_10px_25px_-4px_rgba(28,59,44,0.18),0_4px_12px_rgba(0,0,0,0.08)] ring-1 ring-earth-200/60 shrink-0 flex items-center justify-center transition-all duration-300 group-hover:scale-105 group-hover:shadow-[0_14px_30px_-4px_rgba(197,160,89,0.3),0_6px_16px_rgba(0,0,0,0.12)]">
            ...
            <div className="hidden lg:flex items-center gap-1 px-1 select-none -skew-x-12 shrink-0" aria-hidden="true">
          ...
          <div className="hidden lg:flex items-center shrink-0 ml-auto pl-2">
            <Link
              to="/book-appointment"
